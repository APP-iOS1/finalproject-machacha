...
//MARK: - final을 ObersvableObject로 받는 코드였음
class VoiceViewModel: ObservableObject {
    @Published var final: Bool = false
}

struct VoiceView: UIViewControllerRepresentable {
        @Binding var text: String // text만 개별적으로 binding할 때 필요한 코드
        @ObservedObject var voiceViewModel: VoiceViewModel // ObservableObject 사용할 때 필요한 코드
