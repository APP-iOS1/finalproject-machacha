...
struct Review: Hashable, Identifiable {
	...
	static func getDummy1() -> Self {
		return Review(id: "qsPzae844YI3jljYVoaT", reviewer: "egmqxtTT1Zani0UkJpUW", foodCartId: "InzqNwgl15TytWNOdIZz", grade: 2.3, description: "축구 보면서 머것어요. 완전 맛있어서 정신 못차리고 먹었더니 호떡이 사라지는 마법을 느꼈슴니다.", imageId: [], updatedAt: Date(), createdAt: Date())
	}
    static func getDummy2() -> Self {
        return Review(id: "qsPzae844YI3jljYVoaT", reviewer: "egmqxtTT1Zani0UkJpUW", foodCartId: "InzqNwgl15TytWNOdIZz", grade: 2.3, description: "2", imageId: ["test.jpg"], updatedAt: Date(), createdAt: Date())
    }
    static func getDummy3() -> Self {
        return Review(id: "qsPzae844YI3jljYVoaT", reviewer: "egmqxtTT1Zani0UkJpUW", foodCartId: "InzqNwgl15TytWNOdIZz", grade: 2.3, description: "3", imageId: ["test.jpg", "test.jpg", "test.jpg"], updatedAt: Date(), createdAt: Date())
    }
