...
extension Font {
	...
	static let machachaFootnote: Font = .custom("NanumSquareRoundOTFR", size: 13)
	static let machachaCaption: Font = .custom("NanumSquareRoundOTFR", size: 12)
	...
	static let slowTitle: Font = .custom("whiteAngel.ttf", size: 28)
}
